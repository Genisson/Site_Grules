...
if (!$conn->connect_error){
	...
	if ($result->num_rows > 0) {
		while($row = $result->fetch_assoc()) {
			...
			<a href='cadastro-aluno.php?operacao=2&id=" .  $row["aluno_id"] . "'><input class='form-check-input' type='checkbox' name='selecionar'>
			</td>
			</tr>";
...
?>
			...
			<div class="form-group" align="center">
				<button type="submit" class="btn btn-lg btn-success" name="adicionar"> 
