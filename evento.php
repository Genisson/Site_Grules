...
if (!$conn->connect_error){
	...
	if ($result->num_rows > 0) {
		while($row = $result->fetch_assoc()) {
			...
			<a href='cadastro-evento.php?operacao=2&id=" .  $row["evento_id"] . "'><i class='fas fa-edit' name='editar'></i></a>
			</td>
			<td style='text-align: right;'>
			<a href='delete-evento.php?id=" .  $row["evento_id"] . "'><i style='color: red;' class='fas fa-trash' name='deletar'></i></a>
			</td>
			</tr>";
		}
	} else {
